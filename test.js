...
function preload() {
    ...
    game.load.image('ship', '../refresh/images/player.png');
    game.load.image('bullet', '../refresh/images/bullet.png');
    game.load.image('enemy-green', '../refresh/images/enemy-green.png');
    game.load.spritesheet('explosion', '../refresh/images/explode.png', 128, 128);
}
